...
- **Deterministic Draft Photos** — The gallery feeds deterministic cover/interior layouts through `generateAutoLayout()` and stable spread keys in the workspace flow.
